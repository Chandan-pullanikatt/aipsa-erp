-- CreateEnum
CREATE TYPE "TenantType" AS ENUM ('SCHOOL', 'INDIVIDUAL');

-- AlterEnum
ALTER TYPE "Role" ADD VALUE 'HS_PARENT';

-- AlterTable
ALTER TABLE "tenants" ADD COLUMN     "type" "TenantType" NOT NULL DEFAULT 'SCHOOL';
...
-- CreateIndex
CREATE INDEX "hs_learners_tenantId_idx" ON "hs_learners"("tenantId");

-- CreateIndex
CREATE INDEX "hs_enrollments_tenantId_idx" ON "hs_enrollments"("tenantId");

-- CreateIndex
CREATE UNIQUE INDEX "hs_enrollments_learnerId_courseId_key" ON "hs_enrollments"("learnerId", "courseId");

-- CreateIndex
CREATE INDEX "hs_lesson_progress_tenantId_learnerId_idx" ON "hs_lesson_progress"("tenantId", "learnerId");
...
-- CreateIndex
CREATE INDEX "hs_subscriptions_tenantId_idx" ON "hs_subscriptions"("tenantId");
...
-- AddForeignKey
ALTER TABLE "hs_learners" ADD CONSTRAINT "hs_learners_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "hs_enrollments" ADD CONSTRAINT "hs_enrollments_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "hs_lesson_progress" ADD CONSTRAINT "hs_lesson_progress_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "hs_subscriptions" ADD CONSTRAINT "hs_subscriptions_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
