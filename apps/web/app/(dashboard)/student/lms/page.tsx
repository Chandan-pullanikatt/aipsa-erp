              ...
              {materials.length > 0 && (
                <div className="mb-6 space-y-2">
                  <div className="flex items-center justify-between text-xs font-display">
                    <span className="font-semibold text-gray-600">{completedCount} of {materials.length} completed</span>
                ...
                <div className="space-y-4 relative before:absolute before:inset-y-1 before:left-3.5 before:w-0.5 before:bg-gray-100">
                  {materials.map((mat) => (
                    <div key={mat.id} className="relative pl-10 flex flex-col gap-3 font-body">
                      {/* Timeline dot — green if completed */}
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="space-y-1.5 flex-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <h4 className={`font-bold text-base leading-snug font-display ${mat.completed ? 'text-[#155B37] line-through decoration-[#1D7A4A]/40' : 'text-slate-800'}`}>
                                {mat.title}
                              </h4>
                              {mat.completed && (
