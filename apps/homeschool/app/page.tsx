    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="px-6 sm:px-10 pb-20 max-w-5xl mx-auto grid sm:grid-cols-3 gap-5">
          {[
            { icon: BookOpen, title: "Structured catalog", body: "Courses organised by grade and subject — a clear path, not scattered videos." },
            { icon: Users, title: "Every child", body: "Add each of your children and track them separately under one family account." },
            { icon: BarChart3, title: "Real progress", body: "Mark lessons complete and see how far each child has come." },
          ].map((f) => (
